...
**Screenshot Location**: `docs/images/auto-generated/sql-query-console.png`  
*Screenshot should show SQL queries auto-generated by SQLAlchemy, captured from Flask debug toolbar or database logs*
...
**Screenshot Location**: `docs/images/auto-generated/jinja2-template-escaping.png`  
*Screenshot should show browser inspector with HTML entities demonstrating XSS prevention through auto-escaping*
...
**Screenshot Location**: `docs/images/auto-generated/password-hash-example.png`  
*Screenshot should show bcrypt password hashes in the database, demonstrating unique salts for each password*
...
**Screenshot Location**: `docs/images/auto-generated/session-cookie-inspector.png`  
*Screenshot should show browser developer tools with auto-generated session cookies, highlighting HttpOnly and SameSite flags*
...
**Screenshot Location**: `docs/images/auto-generated/test-fixture-output.png`  
*Screenshot should show pytest running with auto-generated test fixtures, including database creation and cleanup*
...
**Screenshot Location**: `docs/images/auto-generated/json-api-response.png`  
*Screenshot should show auto-generated JSON response from API endpoint with proper date formatting and Content-Type headers*
...
| Category | Tool | Location | Screenshot Location | Justification |
|----------|------|----------|---------------------|---------------|
| **Database Migrations** | Flask-Migrate/Alembic | `migrations/` | `docs/images/auto-generated/database-migration-example.png` | Automatic schema versioning, rollback support |
| **SQL Queries** | SQLAlchemy ORM | Models | `docs/images/auto-generated/sql-query-console.png` | Database abstraction, SQL injection prevention |
| **HTML Escaping** | Jinja2 | Templates | `docs/images/auto-generated/jinja2-template-escaping.png` | XSS prevention, security |
| **Password Hashing** | Werkzeug/bcrypt | User model | `docs/images/auto-generated/password-hash-example.png` | Secure password storage |
| **Session Management** | Flask-Login | Throughout app | `docs/images/auto-generated/session-cookie-inspector.png` | Secure authentication |
| **Test Fixtures** | pytest | `tests/conftest.py` | `docs/images/auto-generated/test-fixture-output.png` | Test isolation and consistency |
| **JSON Serialization** | Flask jsonify | API endpoints | `docs/images/auto-generated/json-api-response.png` | Type-safe API responses |

### Screenshot Documentation

For detailed instructions on capturing and adding screenshots of auto-generated content, see: **`docs/AUTO_GENERATED_CONTENT_SCREENSHOTS.md`**

This guide provides:
- Specific instructions for capturing each type of screenshot
- Technical requirements and styling guidelines
- Markdown syntax for embedding screenshots
- Checklist for completing the documentation
